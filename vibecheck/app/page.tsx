...
const demoEvents: Event[] = [
  ...
  },
  {
    ...
    status: 'in-progress',
    tasks: [
      { id: 1, title: 'Check weather', completed: false, assignee: 'Charlie Brown' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 2, title: 'Arrange catering', completed: false, assignee: 'Wonder Woman' },
    ],
    participants: [
      { id: 'me', name: 'Me', status: 'confirmed' },
  ...
  // === SUGGESTED OPEN (public, not invited - discovery) ===
  {
    id: 21,
  ...
  },
  {
    ...
    status: 'optimal',
    participants: [
      { id: '1', name: 'Mr. Incredible', status: 'confirmed' },
    ],
  },
  {
    id: 23,
  ...
  },
  {
    ...
    description: 'Community flea market. Bring stuff to sell or just browse!',
    hasVoting: false,
    hasTasks: true,
    hasPayment: false,
    organizerId: 'walle',
    ...
    status: 'in-progress',
    participants: [
      { id: '1', name: 'EVE', status: 'confirmed' },
    ],
  },
]
