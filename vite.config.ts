...
// Writes browser logs directly to files in timestamped session folders
// =============================================================================

import { getSessionLogDir } from "./server/lib/logSession";
...
function writeToLogFile(source: LogSource, entries: unknown[]) {
  ...
  const logPath = path.join(sessionDir, `${source}.log`);
 ...
 * - Creates timestamped session folder on startup: logs/YYYY-MM-DD_HH-mm-ss/
